...
func GetXYComponent(magnitude, angle float32) rl.Vector2 {
  return rl.NewVector2(magnitude*float32(math.Sin(float64(angle))), magnitude*float32(math.Cos(float64(angle))))
}
